(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("01ad8016-7185-451d-80fd-1bd6edf28238");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '01ad8016-7185-451d-80fd-1bd6edf28238' but no matching script tag was found.")
        }
